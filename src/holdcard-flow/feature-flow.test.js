...
describe('feature-flow', () => {
  ...
  it('starts on the toggle screen', async () => {
    ...
    expect(el.shadowRoot.querySelector('holdcard-success-screen')).toBeFalsy();
    expect(el.shadowRoot.querySelector('holdcard-error-screen')).toBeFalsy();
  });
  ...
  it('transitions to success screen after successful hold', async () => {
    ...
    expect(el.shadowRoot.querySelector('holdcard-success-screen')).toBeTruthy();
  ...
  it('transitions to error screen when the API rejects', async () => {
    const el = mount('<feature-flow></feature-flow>');
    el.cardStatus = 'active';
    el.service = createMockService({ holdError: { errorCode: 'GENERIC_ERROR', errorTitle: 'Something went wrong', errorMessage: 'Try again', retryable: true } });
    await el.updateComplete;
    ...
    expect(el.shadowRoot.querySelector('holdcard-error-screen')).toBeTruthy();
  });
  ...
  it('returns to toggle screen after retry', async () => {
    ...
    el.shadowRoot.querySelector('holdcard-error-screen')
